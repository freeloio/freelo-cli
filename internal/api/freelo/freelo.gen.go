// Package freelo provides primitives to interact with the openapi HTTP API.
//
...
type CommentFull struct {
	...
	Content      *string    `json:"content,omitempty"`
	DateAdd      *time.Time `json:"date_add,omitempty"`
	DateEditedAt *time.Time `json:"date_edited_at,omitempty"`
	Document     *struct {
		Name *string             `json:"name,omitempty"`
...
type CustomFieldWithValue struct {
	CustomFieldsTypesUuid *openapi_types.UUID `json:"custom_fields_types_uuid,omitempty"`
	FieldDateAdd          *time.Time          `json:"field_date_add,omitempty"`
	...
	ValueDateAdd          *time.Time          `json:"value_date_add,omitempty"`
	ValueDateEditedAt     *time.Time          `json:"value_date_edited_at,omitempty"`
...
type Event struct {
	...
	DateAction *time.Time `json:"date_action,omitempty"`
	Document   *struct {
		Id   *int    `json:"id,omitempty"`
		Name *string `json:"name,omitempty"`
	} `json:"document,omitempty"`
...
type GetTimeTrackingStatusResponse struct {
	...
	JSON200      *struct {
		...
		DateReported *time.Time `json:"date_reported,omitempty"`
